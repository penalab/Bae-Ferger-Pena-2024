...
from powltools.analysis.stim_aggregators import (
    stim_delay,
    stim_len,
    stim_level,
    stim_f_am,
...
from funcs_amplitude_modulation import get_phaselocking_am_stimuli
...
def main():
    ...
    for region in ["ot", "icx"]:
        ...
        print(region, "singlestim_stim_phaselocking".upper())
        ...
        print(region, "twostim_stim_phaselocking".upper())
...
def filter_rate_level_am(filename: str) -> bool:
    return (
        ...
        and "amplitude" in filename
        and not "outside" in filename
    )
